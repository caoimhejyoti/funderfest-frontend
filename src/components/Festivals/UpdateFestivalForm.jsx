...
function UpdateFestivalForm(festivalID) {
  const { id } = useParams();
  const navigate = useNavigate();
  const [originalFestivalDetails, setOrignalFestivalDetails] = useState({
    title: "",
    description: "",
    goal: "",
    image:
  ...
  const [updatedFestivalDetails, setUpdatedFestivalDetails] = useState({
    title: "",
    description: "",
    goal: "",
    image:
  ...
  const handleSubmit = (event) => {
    ...
    if (
      ...
      putUpdateFestival(festivalDetails).then((updatedFestival) => {
      ...
      <form className="container">
        <div className="space-y-12">
          ...
          <div className="border-b border-gray-900/10 pb-12">
            ...
            >
              Events are automatically published. Would you like to keep this as
              a draft?
            </label>
            <input
              type="checkbox"
